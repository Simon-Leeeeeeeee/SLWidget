 ...
 */
public class BadgeLinearLayout extends LinearLayout implements Badge {
    ...
    public BadgeLinearLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mBadgeProxy = new BadgeProxy(this, context, attrs);
    }

    public BadgeLinearLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mBadgeProxy = new BadgeProxy(this, context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public BadgeLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
